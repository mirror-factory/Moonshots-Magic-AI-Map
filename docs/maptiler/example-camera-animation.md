...
Customize camera animations using [`AnimationOptions`](https://docs.maptiler.com/sdk-js/api/properties/#animationoptions).
...
- [Related examples](https://docs.maptiler.com/sdk-js/examples/camera-animation/#related-examples)
